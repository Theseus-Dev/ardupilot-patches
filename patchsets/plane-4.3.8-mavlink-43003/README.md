# Plane 4.3.8 MAVLink 43003 Backport

Patchset for Plane 4.3.8 that adds
`MAV_CMD_EXTERNAL_POSITION_ESTIMATE` (`43003`) support.
...
autotest from ArduPilot PR #23903. It does not add the 4.6.3 no-GPS bootstrap
behavior or `EK3_OPTIONS` changes.
...
Verified locally on the backport branch:
